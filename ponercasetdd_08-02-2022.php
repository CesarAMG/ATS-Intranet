...
global $valores3;
    ...
    switch ($periodo){
      case 1:echo'<tr><td></td><td>'.$t1[$num].'<br /></td>
            <td width="70" align="center" valign="middle">';if ($tipo == 0){selected_tdd($valores[$x],$aux);}else{texto_poner($valores[$x],$aux);}echo '</td>
...
function asistencias($periodo){
    switch ($periodo){
      case 1:lineap01('presente',6);lineap01('ausente',7);//lineap01('retardo',8);
      break;
      case 2:lineap02('presente',6);lineap02('ausente',7);//lineap02('retardo',8);
      break;
      case 3:lineap03('presente',6);lineap03('ausente',7);//lineap03('retardo',8);
      break;
      case 4:lineap04('presente',6);lineap04('ausente',7);//lineap04('retardo',8);
      break;
    }
}
