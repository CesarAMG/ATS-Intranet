...
echo '
        <tr><td>'.$t0[$num].'</td>
                <td width="35" align="center" valign="middle">';echo texto_poner(mysqli_result($resultado_assist,0,$renglon),$renglon);echo'</td>
                <td width="35" align="center" valign="middle">&nbsp;</td>
                <td width="35" align="center" valign="middle">&nbsp;</td>
                <td width="35" align="center" valign="middle">&nbsp;</td>
                <td width="35" align="center" valign="middle">';echo sumar3(mysqli_result($resultado_assist,0,$renglon),0,0,0) ;echo'</td>
        </tr>';
}
...
echo '
        <tr><td>'.$t0[$num].'</td>
                <td width="35" align="center" valign="middle">';echo mysqli_result($resultado_assist1,0,$renglon); echo'</td>
                <td width="35" align="center" valign="middle">';echo texto_poner(mysqli_result($resultado_assist,0,$renglon),$renglon);echo'</td>
                <td width="35" align="center" valign="middle">&nbsp;</td>
                <td width="35" align="center" valign="middle">&nbsp;</td>
                <td width="35" align="center" valign="middle">';echo sumar3(mysqli_result($resultado_assist1,0,$renglon), mysqli_result($resultado_assist,0,$renglon),0,0) ;echo'</td>
        </tr>';
}
...
echo '
        <tr><td>'.$t0[$num].'</td>
                <td width="35" align="center" valign="middle">';echo mysqli_result($resultado_assist1,0,$renglon); echo'</td>
                <td width="35" align="center" valign="middle">';echo mysqli_result($resultado_assist2,0,$renglon); echo'</td>
                <td width="35" align="center" valign="middle">';echo texto_poner(mysqli_result($resultado_assist,0,$renglon),$renglon);echo'</td>
                <td width="35" align="center" valign="middle">&nbsp;</td>
                <td width="35" align="center" valign="middle">';echo sumar3(mysqli_result($resultado_assist1,0,$renglon), mysqli_result($resultado_assist2,0,$renglon), mysqli_result($resultado_assist,0,$renglon),0) ;echo'</td>
        </tr>';
}
...
echo '
        <tr><td>'.$t0[$num].'</td>
                <td width="35" align="center" valign="middle">';echo mysqli_result($resultado_assist1,0,$renglon); echo'</td>
                <td width="35" align="center" valign="middle">';echo mysqli_result($resultado_assist2,0,$renglon); echo'</td>
                <td width="35" align="center" valign="middle">';echo mysqli_result($resultado_assist3,0,$renglon); echo'</td>
                <td width="35" align="center" valign="middle">';echo texto_poner(mysqli_result($resultado_assist,0,$renglon),$renglon);echo'</td>
                <td width="35" align="center" valign="middle">';echo sumar3(mysqli_result($resultado_assist1,0,$renglon), mysqli_result($resultado_assist2,0,$renglon), mysqli_result($resultado_assist3,0,$renglon), mysqli_result($resultado_assist,0,$renglon)) ;echo'</td>
        </tr>';
}
...
function asistencias($periodo){
    switch ($periodo){
      ...
      case 4:lineap04('presente',6);lineap04('ausente',7);lineap04('retardo',8);break;
    }
}
...
echo'<form id="form1" name="form1" method="post" action="grabaralumnotdd.php">
  ...
  <table id="tblUser" width="100%" align="center" cellpadding="0" cellspacing="0">
    <thead>
        ...
        for($ii=1;$ii<=6;$ii++){linea($ii,$periodoactivo,0);}
        titulo(2);
        for($ii=7;$ii<=10;$ii++){linea($ii,$periodoactivo,0);}
        titulo(3);
        for($ii=11;$ii<=12;$ii++){linea($ii,$periodoactivo,0);}
        titulo(4);
        for($ii=13;$ii<=18;$ii++){linea($ii,$periodoactivo,0);}
        titulo(5);
        for($ii=19;$ii<=25;$ii++){linea($ii,$periodoactivo,0);}
        echo '
        <tr>
            <td></td>
            <td colspan="4"></td>
  ...
  <table id="tblUser" width="100%" align="center" cellpadding="0" cellspacing="0">
    <thead>
      ...
      echo asistencias($periodoactivo);echo '
      <tr>
            <td></td>
            <td colspan="4"></td>
            <td align="right"></td>
     ...
     <tr><td valign="top" align="left" width="5"><div id="cor_lt"></div></td>
          <td ></tr>';
    echo  comentarios($periodoactivo);
echo'
    <tr>
    <td valign="top" align="right" width="5"><div id="cor_rt"></div></td></tr>
          <tr><td><div id="cor_lb"></div></td><td></td><td align="right"><div id="cor_rb"></div></td></tr></table>
