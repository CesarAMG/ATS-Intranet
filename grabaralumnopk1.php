...
session_start();
  ...
  $var40 = strip_tags(htmlentities(htmlspecialchars(trim($_POST['var40']))));
  $var41 = strip_tags(htmlentities(htmlspecialchars(trim($_POST['var41']))));
  $var42 = strip_tags(htmlentities(htmlspecialchars(trim($_POST['var42']))));
  $var43 = strip_tags(htmlentities(htmlspecialchars(trim($_POST['var43']))));
  $var44 = strip_tags(htmlentities(htmlspecialchars(trim($_POST['var44']))));
  $var45 = strip_tags(htmlentities(htmlspecialchars(trim($_POST['var45']))));
  $var46 = strip_tags(htmlentities(htmlspecialchars(trim($_POST['var46']))));*/
  ...
  function actualiza_valor_db($aux1,$aux2){
    ...
    $res = $mysqli->query ("update calificaciones
                  set valor = '".$aux1."'
                  where ciclo_id ='".$_SESSION['cicloactivo']."'
                  and periodo = '".$_SESSION['periodoactivo']."'
                  and matricula = '".$_SESSION['matricula']."'
  ...
  actualiza_valor_db($var40,'40');
  actualiza_valor_db($var41,'41');
  actualiza_valor_db($var42,'42');
  actualiza_valor_db($var43,'43');
  actualiza_valor_db($var44,'44');
  actualiza_valor_db($var45,'45');
  actualiza_valor_db($var46,'46');*/
